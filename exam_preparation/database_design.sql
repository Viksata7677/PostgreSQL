...
CREATE TABLE IF NOT EXISTS cars(
    ...
    CONSTRAINT fk_cars_category FOREIGN KEY (category_id) REFERENCES categories(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS cars_drivers(
    ...
    CONSTRAINT fk_cd_cars FOREIGN KEY (car_id) REFERENCES cars(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_cd_drivers FOREIGN KEY (driver_id) REFERENCES drivers(id) ON DELETE CASCADE ON UPDATE CASCADE
);